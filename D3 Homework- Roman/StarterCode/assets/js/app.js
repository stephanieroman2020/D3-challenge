...
function visualize (csvData) {
   ...
   var toolTip = d3.tip()
    ...
    function  labelUpdate(axis, clickText) {
        ...
        // switch when clicked to active
        clickText.classed("inactive", false).classed("active", true);
        }

    // When changed find the min and max
    function xMinMax() {
    ...
    allCircles.append("circle")
        ...
        // Put white state codes on the blue circles
        allCircles
            .append("text")
